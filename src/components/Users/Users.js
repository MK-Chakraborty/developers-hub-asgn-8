...
import DevRating from '../DevRating/DevRating';
    ...
    return (
        <div className="my-3 mx-3">
            <div className="card text-dark bg-warning mb-3 h-100" style={{ "maxWidth": "18rem" }}>
                <div className="card-header"><h4 className="text-success"><i className="fab fa-linkedin px-2"></i> <i className="fab fa-github-square px-2"></i> <i className="fab fa-skype px-2"></i></h4></div>
